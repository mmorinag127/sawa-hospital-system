...
style: |
  ...
  .wide-shot { text-align: center; }
  .wide-shot img { max-width: 100%; max-height: 520px; object-fit: contain; }
...
- Step1.5/1.6実例URL: https://web-stg-avlnzjjrca-dt.a.run.app/orders/ORD93dbb006/workflow-v2
- Step1.5/1.6実例元: prod `ORD58676ddd` をstgへアップロード
- 更新日時: 2026年5月27日水曜日 16:10 JST
- stg revision: web-stg-現行確認版
...
## 12. Step1.5実例: 4点推定はこの状態ならOK

<div class="wide-shot"><img src="./screens/order_processing_workflow_v2_step15_examples/04_step15_quad_good_state_marked.png" alt="step1.5 quad good state"></div>

<p class="caption">
prod <strong>ORD58676ddd</strong> をstgへアップロードした実例です。赤いQ1-Q4が表外枠の四隅に乗り、赤枠がFAX表全体の外枠と平行に重なっている状態なら、<strong>推定4点をOKにしてOCR再実行</strong> で進めます。表の内側、余白、備考欄の途中、ページ端に点が乗っている場合はOKにせず、手動4点指定へ進みます。
</p>

---

## 13. Step1.5: 手動で4点指定する
...
## 14. Step1.6: ヘッダー補正へ入る

<div class="split">
  <div class="shot"><img src="./screens/order_processing_workflow_v2_step15_examples/02_step2_header_fix_button_marked.png" alt="step1.6 entry"></div>
  <div class="notes">
<ul>
...
## 15. Step1.6実例: ヘッダー補正はこの状態ならOK

<div class="wide-shot"><img src="./screens/order_processing_workflow_v2_step15_examples/05_step16_header_axis_good_state_marked.png" alt="step1.6 header axis good state"></div>

<p class="caption">
赤い縦線が、日付・分・献立・各数量列・備考欄の縦罫線に乗り、赤丸が2段ヘッダーの交点に乗っている状態ならOKです。列名の文字中央、手書き線、罫線の途中に吸われている線はずれです。ずれている線を横方向へドラッグし、不足は <strong>縦軸を追加</strong>、余分な線は <strong>選択軸を削除</strong> で整えてから保存します。
</p>

---

## 16. Step1.6: ヘッダー交点を補正する

<div class="split">
  <div class="shot"><img src="./screens/order_processing_workflow_v2_step15_examples/03_step16_header_axis_screen_marked.png" alt="step1.6 header axis"></div>
  <div class="notes">
<ul>
