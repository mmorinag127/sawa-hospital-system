...
size: 16:9
style: |
  section { font-family: "Noto Sans JP", "Hiragino Sans", sans-serif; color: #17201d; background: #f7f8f5; padding: 28px 34px; }
  h1 { font-size: 34px; }
  h2 { font-size: 24px; margin: 0 0 14px; }
  p, li { font-size: 17px; line-height: 1.42; }
  ul, ol { margin: 0; padding-left: 22px; }
  img { border: 1px solid #d6ddd9; border-radius: 6px; }
  .split { display: grid; grid-template-columns: minmax(0, 58%) minmax(0, 42%); gap: 18px; align-items: start; height: 430px; }
  .shot { display: flex; align-items: flex-start; justify-content: center; min-width: 0; }
  .shot img { width: 100%; max-height: 420px; object-fit: contain; }
  .notes { min-width: 0; max-height: 420px; overflow: hidden; padding: 2px 4px; }
