...
module "cloudrun" {
  ...
  env_vars = {
    ...
    API_PROXY_TARGET            = var.cloudrun_worker_url_override != "" ? var.cloudrun_worker_url_override : "https://placeholder.invalid"
  }
  service_env_vars = {
    web = {
    ...
    worker = {
      ...
      OCR_PIPELINE_URL             = var.cloudrun_ocr_pipeline_url_override
      OCR_PIPELINE_TARGET_AUDIENCE = var.cloudrun_ocr_pipeline_url_override
  ...
  service_concurrency = var.cloudrun_service_concurrency
  secret_env_vars     = {}
